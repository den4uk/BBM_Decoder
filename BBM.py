...
from tkinter import Tk,StringVar,IntVar,Menu,Button,Label,N,E,W,S
            ...
            <th nowrap>Sender PIN</th>\
                ...
                for bbm_item in bbm_data:
                        ...
                        if bbm_item[5] != None:
                                ...
                                bbm_msgimg = ''
                        bbm_namepin = escape_html(bbm_item[6])
                        if bbm_item[7] == 1:
                                bbm_mtype = 'PING!'
                        else:
                                bbm_mtype = ''
...
Website: {1}\n\
Author: {2}\n\
E-mail: {3}'.format(__version__, __website__, __author__, __email__))
...
ttk.Checkbutton(downframe, text='Open results in a web browser', var=OpenWeb).grid(row=3, columnspan=2, sticky=W)
